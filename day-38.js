//100 Days Of Code
//Day-38
//Imagine you are building a Text Editor where each action (typing or deleting text) is stored in a Doubly Linked List.
//  This allows you to move backward (Undo) and forward (Redo) through the actions efficiently.
// 👉 Requirements:
...
dList.addActionEnd("type A");
dList.addActionEnd("type B");
dList.addActionEnd("type C");
dList.undo();
dList.redo();
dList.deleteActionEnd();
dList.viewForward();
dList.viewBackward();
